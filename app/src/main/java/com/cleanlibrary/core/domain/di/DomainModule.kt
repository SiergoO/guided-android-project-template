package com.cleanlibrary.core.domain.di

import com.cleanlibrary.core.domain.usecase.GetFirstTitleUseCase
import com.cleanlibrary.core.domain.usecase.GetSecondTitleUseCase
