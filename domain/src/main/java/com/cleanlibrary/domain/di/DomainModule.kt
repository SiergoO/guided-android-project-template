package com.cleanlibrary.domain.di

import com.cleanlibrary.domain.usecase.GetFirstTitleUseCase
import com.cleanlibrary.domain.usecase.GetSecondTitleUseCase
